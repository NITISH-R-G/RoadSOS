                    ...
                    if (destLatLng != null) {
                      ...
                      showDialog<void>(
                        ...
                        builder: (alertCtx) => AlertDialog(
                          ...
                          content: const Text(
                            'No specific destination selected. Do you want to start a 30-minute timer-only Safe Walk? (No live navigation will be available).',
                          ),
                          actions: [
                            TextButton(

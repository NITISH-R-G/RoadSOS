            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    if (monitor.destination != null && monitor.destination != 'your destination')
                      OutlinedButton.icon(
                        ...
                        onPressed: () async {
                          final url = Uri.parse('https://www.google.com/maps/dir/?api=1&destination=${Uri.encodeComponent(monitor.destination!)}');
                    ...
                    ElevatedButton.icon(
                      ...
                      label: const Text('END SAFE PATH', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
              ],

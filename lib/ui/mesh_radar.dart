        ...
        return Container(
          ...
          child: Stack(
            ...
            children: [
              ...
              // Scanning sweep
              // ⚡ Bolt Optimization:
              // What: Moved expensive gradient widget out of builder to the `child` property.
              // Why: Prevents rebuilding and repainting the gradient every frame.
              // Impact: Significantly reduces UI thread usage; 0 unnecessary repaints.
              AnimatedBuilder(

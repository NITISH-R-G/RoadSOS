        ...
        return Container(
          ...
          child: Stack(
            ...
            children: [
              ...
              // Scanning sweep
              // ⚡ Bolt: Re-use the expensive SweepGradient subtree by passing it to `child`.
              // Transform.rotate will only rebuild the rotation transform, not the gradient shader.
              AnimatedBuilder(

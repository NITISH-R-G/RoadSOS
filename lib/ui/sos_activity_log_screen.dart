...
class SosActivityLogScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      // ⚡ Bolt Optimization: Replaced ListView + Column with CustomScrollView + SliverList.builder.
      // Rendering a potentially unbounded list (history items) inside a Column nested within a ListView
      // defeats list virtualization, building all items at once. Using slivers ensures O(1) visible
      // rendering instead of O(n) total item rendering, improving performance as the history grows.

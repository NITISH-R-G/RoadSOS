          ...
          history.when(
            data: (items) {
              ...
              return SliverPadding(
                ...
                // ⚡ Bolt Optimization: Replace ListView + Column with CustomScrollView + SliverList.builder
                // This ensures O(1) rendering of visible items instead of eagerly building the entire unbounded list.

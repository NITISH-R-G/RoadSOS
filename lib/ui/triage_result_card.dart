  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          _HeaderSection(result: result, severe: severe),
          _ServicesSection(result: result),
          _FirstAidSection(result: result),
...
class _HeaderSection extends StatelessWidget {
  ...
  const _HeaderSection({required this.result, required this.severe});

  @override
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context)!;
    final scheme = Theme.of(context).colorScheme;
    return // ── Header: severity + confidence ────────────────────────────────
    Container(
...
class _ServicesSection extends StatelessWidget {
  ...
  const _ServicesSection({required this.result});
...
class _FirstAidSection extends StatelessWidget {
  ...
  const _FirstAidSection({required this.result});

  @override
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context)!;
    final scheme = Theme.of(context).colorScheme;
    return // ── First-aid guidance (RAG) ──────────────────────────────────────
    Padding(
      padding: const EdgeInsets.all(16),
      child: Container(
...
class _PayloadSection extends StatelessWidget {
  ...
  const _PayloadSection({required this.result});

  @override
  Widget build(BuildContext context) {
    final scheme = Theme.of(context).colorScheme;
    return // ── Compressed payload (BLE mesh / SMS interop) ───────────────────
    Padding(
